package com.example.platzil.platzigram.adapter;
...
import com.example.platzil.platzigram.view.PictureDeatailActivity;
...
/**
 * Created by Payall on 16-06-2017.
 */
    ...
    public void onBindViewHolder(PictureViewHolder holder, int position) {
        ...
        holder.imageCard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(activity, PictureDeatailActivity.class);
